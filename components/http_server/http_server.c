...
static const char ROOT_PAGE_HTML[] =
    ...
    ".pixel-table{border-collapse:collapse;margin-top:8px}"
    ".pixel-table td{width:16px;height:16px;border:1px solid #d7dbe3;background:#f2f4f8}"
    ".pixel-table td.on{background:#2d6cdf}"
    ".status{font-size:14px;color:#556;opacity:0.9}"
    "</style>"
    "</head>"
    "<body>"
    ...
    "<h2>Pixel Table</h2>"
    "<p class='status'>Simple 8x8 test pattern</p>"
    "<table class='pixel-table' aria-label='8 by 8 pixel table'>"
    "<tr><td class='on'></td><td></td><td></td><td class='on'></td><td class='on'></td><td></td><td></td><td class='on'></td></tr>"
    "<tr><td></td><td class='on'></td><td></td><td></td><td></td><td></td><td class='on'></td><td></td></tr>"
    "<tr><td></td><td></td><td class='on'></td><td></td><td></td><td class='on'></td><td></td><td></td></tr>"
    "<tr><td class='on'></td><td></td><td></td><td class='on'></td><td class='on'></td><td></td><td></td><td class='on'></td></tr>"
    "<tr><td class='on'></td><td></td><td></td><td class='on'></td><td class='on'></td><td></td><td></td><td class='on'></td></tr>"
    "<tr><td></td><td></td><td class='on'></td><td></td><td></td><td class='on'></td><td></td><td></td></tr>"
    "<tr><td></td><td class='on'></td><td></td><td></td><td></td><td></td><td class='on'></td><td></td></tr>"
    ...
    "    if(!r.ok){document.getElementById('status').textContent='Status unavailable.';return;}"
    "    const j=await r.json();"
    "    const size=j.image_size||0;"
    "    document.getElementById('status').textContent=`Server OK. Latest image size: ${size} bytes.`;"
